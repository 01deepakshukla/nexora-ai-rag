    ...
    <div className="auth-page">
      <div className="auth-art">
        ...
        <div className="art-quote">
          <p>“Build a thinking space that meets you where you are.”</p>
      ...
      <div className="auth-panel">
        <div className="auth-content">
          <span className="eyebrow">Start your studio</span>
          <h1>Create your account</h1>
          <p className="auth-subtitle">A calm place for ambitious ideas.</p>
